# OKRs y Métricas — UGC Colombia

**Fecha base:** 2026-04-08 (Mes 0, arranque Q2 2026)
**Fuente canónica:** Documento Maestro v1.0 (2025)
**Meta 12 meses:** $70K–$98K USD/mes recurrente (MRR) — rango oficial Q4 del doc maestro
**Planes oficiales:** Starter $500 (5 videos) / Growth $900 (10 videos) / Scale $1.500 (20 videos) / Enterprise desde $3.000
**Ticket promedio progresivo:** $900 (Q1) → $1.100 (Q2) → $1.200 (Q3) → $1.400 (Q4)
**Ruta oficial de clientes:** 8–12 (Q1) → 15–20 (Q2) → 25–35 (Q3) → 50–70 (Q4)
**Equipo:** Alexander Cast (CEO & Estratega), Brian Velásquez (Líder Admin & Financiero), Diana Mile (Líder de Creadores), Samuel (Líder de Tecnología), Tanya (Líder de Comunidades)

---

## 1. North Star Metric (NSM)

### NSM: **MRR Activo Cobrado en USD**

Una sola métrica que captura salud comercial, retención y cobranza efectiva. No vale "vendido", vale "cobrado y activo".

### Árbol de métricas derivadas

```
                    MRR ACTIVO COBRADO (NSM)
                            |
        ┌───────────────────┼───────────────────┐
        |                   |                   |
   NUEVO MRR          MRR EXPANSION         MRR PERDIDO (-)
   (new logos)        (upsells)             (churn)
        |                   |                   |
   ┌────┴────┐         ┌────┴────┐         ┌────┴────┐
   Leads     Close     Upsell    NPS       Logo      Revenue
   Calificados Rate    Rate      Score     Churn     Churn
   |          |        |         |         |         |
   CAC        Demos    QBRs      Health    Renewal   Downgrade
   Source     Hechas   Trigger   Score     Rate      Rate
        |
   ┌────┴────┐
   Tráfico   Conv. Lead
   (IG, web, (form/llamada)
...
### Métricas espejo (counter-metrics para evitar gaming)

- **Gross Margin %** (no quemar plata cerrando barato)
- **Delivery Health Score** (1-10) — calidad de entregables por cliente
- **Creator NPS** — salud del lado de oferta (creadores)

---

## 2. OKRs Anuales Oficiales — Doc Maestro v1.0
...
## 3. OKRs Q2 2026 (Abril – Junio)

> **Tema del trimestre:** "Cimientos que escalan" — montar máquina de adquisición + delivery repetible.
...
- Webinar mensual "Cómo escalar UGC en LATAM 2026" (lead magnet)
- Pricing oficial publicado: Starter / Pro / Premium

**Dependencias:** KREOON web stack (Samuel), Jarvis para agendamiento WhatsApp (Alexander)
**Riesgos:** Pipeline pobre por falta de tráfico orgánico → mitigar con paid (Meta Ads $1K/mes)
...
- Playbook de briefs estandarizado por vertical (e-commerce, SaaS, app, food)
- Sistema de QA: revisión doble antes de enviar a cliente

**Dependencias:** Tooling KREOON / Notion templates (Samuel)
**Riesgos:** Creadores no profesionales → contrato + escrow + sistema de rating
...
- Calendario editorial IG: 5 posts/semana + 10 reels/semana (Tanya)
- Manual de marca v1.0 (tono, colores, plantillas)

**Dependencias:** Decisión de stack tech (Atomic CRM vs HubSpot)
**Riesgos:** Sobrecarga operativa de 5 personas haciendo todo → priorizar foco

---

## 3. OKRs Q3 2026 (Julio – Septiembre) — Proyección

> **Tema del trimestre:** "Repetibilidad" — del esfuerzo heroico al sistema.
...
### Diana (Creadores / Delivery)

**Diario:** Briefs activos, entregas pendientes hoy, alertas de retraso
**Semanal:** Delivery Health Score por cliente, creadores activos, retrabajos
...
**Diario:** Uptime de stack (web, CRM, Jarvis), bugs críticos abiertos
...
### Tanya (Comunidades / Contenido)

**Diario:** Posts publicados, mensajes/comentarios respondidos, leads de IG
**Semanal:** Followers netos, engagement rate, alcance, top contenido
...
- Testimoniales y caso de estudio

**Acción Q2:** Samuel construye módulo "Briefs y Creadores" en KREOON usando UGC Colombia como cliente cero.
...
**Acción Q2:** Diseñar oferta combinada "UGC + Ads Management" como upsell a $1,500+ del plan Premium.
...
- Recordatorios de entregas a creadores
...
**Acción Q2:** Conectar formulario landing UGC → Jarvis → Calendly de Alexander. Meta: 80% de SQL agendados sin intervención humana.
...
## 8. Decisiones Clave Pendientes — Esta Semana

> Alexander, estas son las decisiones que **bloquean** el arranque de Q2. Cerrarlas antes del viernes 11 abril.

1. **Pricing definitivo y método de cobro**
   - ¿Stripe + Wise? ¿Aceptamos COP o solo USD? ¿Descuento por pago anual?
   - **Decisión esperada:** lunes
   - **Bloquea:** landing, contratos, propuestas

2. **Stack CRM: Atomic CRM (Supabase) vs HubSpot Free vs Notion**
   - Atomic = control total + sinergia KREOON, pero requiere 2 semanas Samuel
   - HubSpot = ya y gratis, pero data fuera del ecosistema
   - **Decisión esperada:** martes
   - **Bloquea:** Samuel arranca dev o conecta cuentas

3. **Presupuesto Meta Ads para Q2 (validar $3K total trimestre)**
   - ¿De dónde sale? ¿Capital propio o reinversión primera factura?
   - **Decisión esperada:** martes
   - **Bloquea:** Tanya/Alexander lanzan campañas semana 2

4. **Los 2 pilotos gratis: ¿qué marcas?**
   - Necesitamos 2 marcas con tracción (no startups muertas) que acepten ser caso de estudio
   - **Decisión esperada:** miércoles
   - **Bloquea:** primer entregable real, primer caso de estudio

5. **Roles oficiales y comp del equipo**
   - ¿Brian, Diana, Samuel, Tanya son socios, equity, salario fijo, variable?
   - Sin claridad → fricciones en M2-M3
...
7. **Política de uso de Jarvis comercial**
   - ¿Jarvis responde como "Alexander"? ¿Como bot? ¿Mix?
   - **Decisión esperada:** miércoles
   - **Bloquea:** integración WhatsApp comercial

---

## Apéndice: Fórmulas y supuestos

- **MRR objetivo M12:** 110 clientes x $750 promedio x 1.21 mix premium = ~$100K
- **CAC target:** $300 (LTV $750 x 12 meses x 60% margen = $5,400 → LTV/CAC = 18x)
- **Payback:** 4-5 meses
- **Burn aceptable Q2:** ≤$8K USD (paid media + tooling + operación mínima)
- **Punto de equilibrio:** ~12 clientes activos ($9K MRR)

---

**Próxima revisión de este documento:** lunes 14 de abril 2026 (post-decisiones)
**Owner del documento:** Alexander Cast
**Versión:** 1.0
