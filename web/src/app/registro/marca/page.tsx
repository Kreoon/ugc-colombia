...
export const metadata: Metadata = {
  title: "Registro Marcas | UGC Colombia × KREOON",
  description:
    "Registra tu marca en UGC Colombia y conecta con creadores UGC para tus campañas.",
};
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="hidden lg:block animate-fade-in">
              ...
              <h2 className="font-display text-5xl xl:text-6xl text-white tracking-wide uppercase leading-[1.05] mb-6">
                Conecta con <span className="text-brand-yellow">creadores reales</span>
              </h2>
              <p className="text-brand-gray font-sans text-lg leading-relaxed mb-8 max-w-md">
                Lanza campañas con creadores UGC verificados de Colombia.
                Briefs, pagos seguros y tracking en una sola plataforma.
              </p>
              <ul className="space-y-4 text-brand-gray font-sans">
                {[
                  "Acceso a +500 creadores activos",
                  "Briefs y pagos automatizados",
            ...
            <div>
              <RegistrationForm initialType="brand" />
            </div>
          </div>
        </section>
      </main>
