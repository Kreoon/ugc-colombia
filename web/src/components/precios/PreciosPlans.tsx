...
function PlanCard({
  ...
  return (
    ...
    >
      ...
      {/* Pulse glow sutil para plan destacado */}
      {plan.highlight && (
        <div
          aria-hidden
          className="absolute inset-0 rounded-2xl pointer-events-none animate-[glow-pulse_2.5s_ease-in-out_infinite]"
          style={{
            boxShadow: "0 0 40px -15px rgba(249,179,52,0.3)",
          }}
        />
      )}
        ...
        <div className="flex flex-col justify-center gap-6">
          ...
          <div className="rounded-2xl border-2 border-brand-gold/50 bg-brand-yellow/5 p-6 sm:p-8">
            ...
            <button
              ...
              aria-label="Agendar llamada para plan a la medida"
            >
